      ...
      {FLOORS.map(({ code, title, size, body }, i) => (
        <ScrollReveal key={code} delay={i * 0.1}>
          ...
          >
            ...
            <div style={{ fontFamily: "Jost, sans-serif", fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", color: "#B2B2B2", marginBottom: 16 }}>{code}</div>
            ...
            <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: 36, fontWeight: 300, color: "#B2B2B2", lineHeight: 1, marginBottom: 16 }}>{size}</div>
    ...
    >
      <ScrollReveal>
        <div style={{ maxWidth: 500 }}>
          <p style={{ fontFamily: "Jost, sans-serif", fontSize: "9.5px", letterSpacing: "0.4em", textTransform: "uppercase", color: "rgba(255,255,255,0.35)", marginBottom: 24 }}>
