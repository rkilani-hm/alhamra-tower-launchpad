...
/* Eastern-Arabic numeral conversion is DISABLED.
   The project standard is Western (Latin) digits everywhere, including Arabic,
   per the documented convention in src/index.css ("force Latin (Western) digits
   everywhere for consistency with the luxury real-estate convention used in Gulf
   business content"). This helper is now an identity passthrough so CMS editors
   keep whatever digits the manager types. Kept as an exported no-op to preserve
   every call site's signature; re-enable the body to restore conversion. */
