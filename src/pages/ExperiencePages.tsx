...
const SERVICES_CONTENT = {
  en: {
    ...
    systems: [
      ...
      { number: "07", title: "Parking, Valet and Shuttle", body: "An eleven level car park holding more than 2,000 structured spaces, valet arrival at the main entrance and an internal shuttle to Dasman Parking. Request your car by QR code from your desk and it is waiting when you reach the lobby." },
      { number: "08", title: "EV Charging Stations",     body: "Dedicated electric-vehicle charging bays within the car park, allowing tenants and visitors to charge on site throughout the working day." },
    ],
  ...
  ar: {
    ...
    systems: [
      ...
      { number: "٠٧", title: "المواقف وخدمة صف السيارات والنقل الداخلي", body: "مواقف من أحد عشر مستوى تضم أكثر من 2,000 موقف منظم، وخدمة صف سيارات عند المدخل الرئيسي، ونقل داخلي إلى مواقف دسمان. اطلب سيارتك برمز QR من مكتبك لتجدها بانتظارك عند وصولك البهو." },
      { number: "٠٨", title: "محطات شحن السيارات الكهربائية", body: "مواقفُ مخصّصةٌ لشحن السيارات الكهربائية ضمن مَرفِق المواقف، تتيح للمستأجرين والزوار شحن مركباتهم في الموقع طوال يوم العمل." },
    ],
...
const LEASING_CONTENT = {
  en: {
    ...
    stats: [
      ...
      { number: "3.2", unit: " m", label: "Ceiling height" },
    ],
    quote: "\"Every office.\nEvery corner.\nAn unbroken horizon.\"",
  ...
  ar: {
    ...
    stats: [
      ...
      { number: "٣٫٢", unit: " م", label: "ارتفاع السقف" },
    ],
    quote: "«كلّ مكتب.\nكلّ زاوية.\nأفقٌ لا ينقطع.»",
