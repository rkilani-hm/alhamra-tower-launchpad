...
const SERVICES_CONTENT = {
  ...
  ar: {
    ...
    systems: [
      { number: "٠١", title: "الأنظمة الكهربائية",       body: "خمس محطات كهرباء فرعية مخصّصة موزّعة على القبو الثاني، والطوابق ٤ و٢٧ و٥٢ و٧٦، تضمن إمداداً متواصلاً للكهرباء، مع احتياطي كامل عبر مولدات تكفل استمرارية التشغيل على جميع طوابق المكاتب الـ ٦٢ دون انقطاع." },
...
const LEASING_CONTENT = {
  en: {
    ...
    stats: [
      ...
      { number: "62", label: "Dedicated office floors" },
    ],
    quote: "\"Every office.\nEvery corner.\nAn unbroken horizon.\"",
  ...
  ar: {
    ...
    stats: [
      ...
      { number: "٦٢", label: "طابقاً مكتبياً" },
    ],
    quote: "«كلّ مكتب.\nكلّ زاوية.\nأفقٌ لا ينقطع.»",
