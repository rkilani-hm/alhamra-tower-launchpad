...
const SERVICES_CONTENT = {
  en: {
    ...
    systems: [
      ...
      { number: "07", title: "EV Charging Stations",     body: "Dedicated electric-vehicle charging bays within the car park, allowing tenants and visitors to charge on site throughout the working day." },
    ],
  ...
  ar: {
    ...
    systems: [
      ...
      { number: "٠٧", title: "محطات شحن السيارات الكهربائية", body: "مواقفُ مخصّصةٌ لشحن السيارات الكهربائية ضمن مَرفِق المواقف، تتيح للمستأجرين والزوار شحن مركباتهم في الموقع طوال يوم العمل." },
    ],
