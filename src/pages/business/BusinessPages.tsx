...
const OFFICE_CONTENT = {
  en: {
    ...
    gallery: [
      { src: "/assets/lobby-grand-lamella.jpg",     cap: "Meeting Rooms · Quiet, Considered",     pos: "center" },
      { src: "/assets/lobby-elevator-corridor.jpg", cap: "Elevator Hall · Travertine & Lamella", pos: "center" },
      { src: "/assets/offices-south-corridor.jpg",  cap: "Office Corridor · Breakout Booths",     pos: "center" },
      { src: "/assets/entrance-night-wide.jpg",     cap: "Boardroom · Gulf-View Meetings",        pos: "center" },
    ],
  ...
  ar: {
    ...
    gallery: [
      { src: "/assets/lobby-grand-lamella.jpg",     cap: "غرفُ الاجتماعات · هدوءٌ وتركيز",               pos: "center" },
      { src: "/assets/lobby-elevator-corridor.jpg", cap: "قاعةُ المصاعد · التراڤرتين واللاميلا",           pos: "center" },
      { src: "/assets/offices-south-corridor.jpg",  cap: "ممرُّ المكاتب · مقصوراتُ الاستراحة",            pos: "center" },
      { src: "/assets/entrance-night-wide.jpg",     cap: "قاعةُ اجتماعات · بإطلالةٍ على الخليج",           pos: "center" },
    ],
