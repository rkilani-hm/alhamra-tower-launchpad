...
const OFFICE_CONTENT = {
  ...
  ar: {
    ...
    gallery: [
      { src: "/assets/lobby-grand-lamella.jpg",     cap: "الردهةُ الكبرى · أقواسُ اللاميلا البيضاء",      pos: "center" },
      { src: "/assets/lobby-elevator-corridor.jpg", cap: "قاعةُ المصاعد · تراڤرتين ولاميلا",              pos: "center" },
      { src: "/assets/offices-south-corridor.jpg",  cap: "ممرُّ المكاتب · تشطيباتُ التراڤرتين",           pos: "center" },
